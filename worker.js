...
function validateSqlIdentifier(value, type) {
  const whitelist = {
    column: ['id', 'name', 'url', 'description', 'sort_order', 'is_public', 'last_checked', 'last_status', 'timestamp'],
    table: ['monitored_sites', 'site_status_history'],
    order: ['ASC', 'DESC']
  };
...
<body>
    ...
    <footer class="footer fixed-bottom py-2 bg-light border-top">
        <div class="container text-center">
            <span class="text-muted small">网站监控面板 &copy; 2025</span>
...
document.addEventListener('DOMContentLoaded', function() {
        // Check if we're on the main page by looking for the site table
    ...
    // Initialize periodic updates for site data
